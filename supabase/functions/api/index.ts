...
const permissionDependencies: Record<string, string[]> = {
  ...
  'forms.view': ['forms.create', 'forms.approve', 'forms.access','forms.type.leave_daily','forms.type.leave_hourly','forms.type.leave_sick','forms.type.mission','forms.type.loan','forms.type.payslip','forms.type.resignation','forms.type.equipment','forms.type.personnel'],
  'forms.create': ['forms.type.leave_daily','forms.type.leave_hourly','forms.type.leave_sick','forms.type.mission','forms.type.loan','forms.type.payslip','forms.type.resignation','forms.type.equipment','forms.type.personnel'],
