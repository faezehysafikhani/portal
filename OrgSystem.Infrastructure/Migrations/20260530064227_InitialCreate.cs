        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToExternalName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ToExternalOrg = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FormApprovalSteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FormApprovalSteps_FormInstances_FormInstanceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormApprovalSteps_FormInstanceId",
                table: "FormApprovalSteps",
